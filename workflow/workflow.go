...
// Cleanup cleans up the DBOS runtime.
...
func New[I any, O any](workflow dbos.Workflow[I, O], opts ...dbos.WorkflowRegistrationOption) *Workflow[I, O] {
